...
const columns: ColumnDef<DataGridFeatures, z.infer<typeof schema>>[] = [
  {
    id: "drag",
    header: () => null,
...
function DraggableRow({ row }: { row: Row<DataGridFeatures, z.infer<typeof schema>> }) {
            ...
            <>
              ...
              <div className="grid gap-2">
                <div className="flex gap-2 leading-none font-medium">
                  Trending up by 5.2% this month <ChartUpIcon className="size-4" />
                </div>
