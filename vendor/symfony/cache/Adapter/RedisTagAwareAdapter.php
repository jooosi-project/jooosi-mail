...
class RedisTagAwareAdapter extends AbstractTagAwareAdapter
{
    ...
    public function __construct(\Redis|Relay|\RedisArray|\RedisCluster|\JooosiMailDeps\Predis\ClientInterface $redis, string $namespace = '', int $defaultLifetime = 0, ?MarshallerInterface $marshaller = null)
    {
