...
final class LifecycleManager
{
    public function __construct(
        private readonly HookRegistrar $hookRegistrar,
        private readonly RestRouteRegistrar $restRouteRegistrar,
        private readonly CommandRegistrar $commandRegistrar,
        private readonly MigrationRunner $migrationRunner,
        private readonly ActionSchedulerTrigger $actionSchedulerTrigger,
        private readonly MailLogRetentionScheduler $mailLogRetentionScheduler,
    ) {
    }
