...
final class AttributeDiscovery
{
    ...
    public function discover(): DiscoveryManifest
    {
        ...
        return new DiscoveryManifest(
            services: $this->sortedValues($services),
            controllers: $this->sortedValues($controllers),
            commands: $this->sortedValues($commands),
            profiles: $this->sortedValues($profiles),
            messageHandlers: $this->sortedValues($messageHandlers),
            transportFactories: $this->sortedValues($transportFactories),
        );
    }
