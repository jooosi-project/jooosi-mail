...
{
    public function __construct(private readonly DatabaseReceiver $databaseReceiver, private readonly MessageBusInterface $messageBus, private readonly RetryDecider $retryDecider, private readonly MailLogRepository $mailLogRepository, private readonly EventPublisherInterface $eventPublisher, private readonly QueueMaintenanceService $queueMaintenanceService, private readonly MailLogRetentionService $mailLogRetentionService)
    {
    }
    /**
     * @since 0.1.0
