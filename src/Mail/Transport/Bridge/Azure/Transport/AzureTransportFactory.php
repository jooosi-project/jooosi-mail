...
final class AzureTransportFactory extends AbstractTransportFactory
{
    public function create(Dsn $dsn): TransportInterface
    {
        ...
        return (new \JooosiMail\Mail\Transport\Bridge\Azure\Transport\AzureApiTransport($password, $user, $disableTracking, $apiVersion, $this->client, $this->dispatcher, $this->logger))->setHost($host);
    }
