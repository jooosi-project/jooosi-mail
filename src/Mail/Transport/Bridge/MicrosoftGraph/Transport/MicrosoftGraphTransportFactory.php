...
final class MicrosoftGraphTransportFactory extends AbstractTransportFactory
{
    public function create(Dsn $dsn): TransportInterface
    {
        ...
        return new \JooosiMail\Mail\Transport\Bridge\MicrosoftGraph\Transport\MicrosoftGraphApiTransport($graphEndpoint, $tokenManager, $noSave, $this->client, $this->dispatcher, $this->logger);
    }
