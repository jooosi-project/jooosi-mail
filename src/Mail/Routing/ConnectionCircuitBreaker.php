...
final class ConnectionCircuitBreaker
{
    ...
    public function __construct(private readonly CircuitBreakerStateRepository $circuitBreakerStateRepository, private readonly OptionStore $optionStore, private readonly EventPublisherInterface $eventPublisher)
    {
    }
    /**
     * @since 0.1.0
